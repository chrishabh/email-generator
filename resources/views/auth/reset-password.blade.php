...
<head>
    ...
    <title>Reset Password | bouncee</title>
        ...
        <div class="col-form">
            <div class="col-form--center">
                ...
                <div class="sign-form">
                    ...
                    <form method="POST" accept-charset="utf-8" class="form-inner" id='resetPassword' action="{{ route('recovery') }}">
                        @csrf
                        ...
                        <button class="btn fullwidth" type="submit" style="margin-top: 4em;" id="resetPassword">Reset</button>
