...
@if(request()->is('tools') || request()->is('clay') || request()->path()=='Api' || request()->path()=='single' || request()->path()=='bulk' || request()->path()=='pricing' ||request()->path()=='lead-finder'||request()->path()=='profile' ||request()->path()=='payment-history' ||request()->path()=='settings')
