...
@if(request()->path()=='customRoute' || request()->path()=='single' || request()->path()=='bulk' || request()->path()=='pricing' ||request()->path()=='lead-finder'||request()->path()=='profile' ||request()->path()=='payment-history' ||request()->path()=='settings')
