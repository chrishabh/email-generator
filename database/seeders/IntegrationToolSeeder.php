...
class IntegrationToolSeeder extends Seeder
{
    ...
    public function run()
    {
        $tools = [ 
            ...
            ['icon' => 'google_sheet.svg', 'name' => 'Google Sheets', 'slug' => 'google sheets','client_id'=>env('google_client_id'),'client_secret'=>env('google_client_secret'),'url'=>json_encode(['redirect_url'=> (strtolower(env('APP_ENV')) === 'Production') ? 'https://bouncee.net/googleSheets/callback' :'http://localhost:8000/googleSheets/callback','auth_login_url'=>'https://accounts.google.com/o/oauth2/auth','auth_token_url'=>'https://oauth2.googleapis.com/token',"auth_provider_x509_cert_url"=>"https://www.googleapis.com/oauth2/v1/certs",'base_api_url'=>'https://api.hubapi.com/'])],
