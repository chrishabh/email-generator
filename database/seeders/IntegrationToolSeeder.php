...
class IntegrationToolSeeder extends Seeder
{
    ...
    public function run()
    {
        $tools = [ 
            ...
            ['icon' => 'google_sheet.svg', 'name' => 'Google Sheets', 'slug' => 'google sheets','client_id'=>env('GOOGLE_CLIENT_ID'),'client_secret'=>env('GOOGLE_CLIENT_SECRET'),'url'=>json_encode(['redirect_url'=> (strtolower(env('APP_ENV')) === 'Production') ? 'https://bouncee.net/googlesheet/callback' :'http://localhost:8000/googlesheet/callback','auth_login_url'=>'https://accounts.google.com/o/oauth2/auth','auth_token_url'=>'https://oauth2.googleapis.com/token',"auth_metadata_url"=>"https://www.googleapis.com/oauth2/v3/userinfo",'base_api_url'=>'https://sheets.googleapis.com/v4/'])],
