...
class IntegrationToolSeeder extends Seeder
{
    ...
    public function run()
    {
        $tools = [ 
            ...
            ['icon' => 'constant_contact.svg', 'name' => 'Constant Contact', 'slug' => 'constant contact', 'client_id' => env('CONSTANT_CONTACT_CLIENT_ID'), 'client_secret' => env('CONSTANT_CONTACT_SECRET_KEY'), 'url' => json_encode(['redirect_url' => (strtolower(env('APP_ENV')) === 'Production') ? 'https://bouncee.net/constantcontact/callback' : 'http://localhost:8000/constantcontact/callback','auth_login_url' => 'https://authz.constantcontact.com/oauth2/default/v1/authorize','auth_token_url' => 'https://authz.constantcontact.com/oauth2/default/v1/token','auth_metadata_url' => 'https://api.cc.email/v3/account/summary', 'base_api_url' => 'https://api.cc.email/v3/'])],
