...
class IntegrationToolSeeder extends Seeder
{
    ...
    public function run()
    {
        $tools = [ 
            ...
            ['icon' => 'campaign-monitor.png', 'name' => 'Campaign Monitor', 'slug' => 'campaign monitor', 'client_id' => env('CAMPAIGN_MONITOR_CLIENT_ID'), 'client_secret' => env('CAMPAIGN_MONITOR_CLIENT_SECRET'), 'url' => json_encode(['redirect_url' => (strtolower(env('APP_ENV')) === 'Production') ? 'https://bouncee.net/campaignmonitor/callback' : 'http://localhost:8000/campaignmonitor/callback', 'auth_login_url' => 'https://api.createsend.com/oauth', 'auth_token_url' => 'https://api.createsend.com/oauth/token',  'auth_metadata_url' => null,'base_api_url' => 'https://api.createsend.com/api/v3.3/'])],
