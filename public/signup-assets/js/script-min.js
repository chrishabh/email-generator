    ...
    (function ($) {
        ...
        window.customscripts = $.extend({}, {
            ...
            init: function () {
                ...
                customscripts.initDropdown();
                customscripts.initTabs();
                customscripts.passField();
                customscripts.openModal();
                customscripts.sidebarChange();
            ...
            initSelect: function(){
                ...
                jQuery(document).on('click', '.custom-select .list-values a', function(){
                    ...
                    if(!$(this).hasClass('current')){
                        trigger.removeClass('active').html($(this).html());
                ...
                $(document).on('click',".scroll_to",function (e) {
                    ...
                    if($('[data-id="'+elementClick+'"]').length){
                        ...
                        if($('.mainheader').length ){
                            destination = $('[data-id="'+elementClick+'"]').offset().top - $('.mainheader').outerHeight();
                        }
           ...
           initDropdown: function () {
                $(document).on('click',".toggle_menu",function (e) {
                    $(this).parents('.toggle_dropdown_wrap').toggleClass('opened');
                });
            },
            initTabs: function () {
                $(document).on('click','.tab-item a', function (e) {
                    ...
                    if(!$(this).parent().hasClass('current')){
                        parent.find('.tab-item').removeClass('current');
            ...
            passField:function () {
                $(document).on('click','.toggle_pass', function (e) {
                    var parent = $(this).parents('.pass_field');
            ...
            openModal: function () {
                function showHideModal(targ,trig) {
                    $(document).on('click','.'+trig,function (e) {
                        e.preventDefault();
                        $('.'+targ).addClass("is-visible");
                    })
                    $(document).on('click',".close_modal",function (e) {
                        e.preventDefault();
                        $('.'+targ).removeClass("is-visible");
                    });
                    ...
                    $(document).on('click', function(event){
                        if( !$(event.target).hasClass('modal-inner') && !$(event.target).hasClass(trig) && !$(event.target).parents().hasClass('modal-inner') && !$(event.target).parents().hasClass(trig) ) {
                ...
                showHideModal('popup-results','open_results_popup');
            },
            sidebarChange: function () {
                $(document).on('click','.show_hidden_aside', function (e) {
                    e.preventDefault();
                    $('.current_aside').addClass('hidden');
                    $('.hidden_aside').addClass('show');
                })
                $(document).on('click','.show_current_aside', function (e) {
                    e.preventDefault();
                    $('.current_aside').removeClass('hidden');
                    $('.hidden_aside').removeClass('show');
                })
            }
